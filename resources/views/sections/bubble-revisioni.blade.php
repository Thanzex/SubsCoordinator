            ...
            <div class="card border-{{ $bubble['type'] }} mb-1">
              <div class="card-body">
                <div class="row inline align-items-center">
                  ...
                  <div class="col-auto card-text">
                    S:{{ $data['season'] }} E:{{$data['episode'] }} Consegna: {{$data['deadline']}}
                  </div>
                  <div class="col text-right">
                    <a name="magnet" id="magnet" class="btn btn-primary mr-1" href="{{$data['magnet']}}" role="button">
                      <i class="fas fa-magnet"></i>
                    </a>
                    <a name="diretto" id="dirett" class="btn btn-primary mr-1" href="{{--  DIRETTO --}}" role="button">
                      <i class="fas fa-cloud-download-alt"></i>
                    </a>
                    <a name="base" id="base" class="btn btn-primary mr-1" href="{{$data['base']}}" role="button">
                      <i class="fas fa-file-alt"></i>
                    </a>
                    <a name="facebook" id="facebook" class="btn btn-primary mr-1" href="{{$data['facebook']}}" role="button">
